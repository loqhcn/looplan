...
const newsModel = dataSpace.useModel('main/sl_test_news'); // dataSpace 新闻模型
const newsModel_user = dataSpace_user.useModel('main/sl_test_news'); // dataSpace_user 用户新闻模型
const newsModel_provider = dataSpace_provider.useModel('main/sl_test_news'); // dataSpace_provider 服务提供方新闻模型
