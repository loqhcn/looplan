...
const state = reactive({
    ...
    list: [
        ...
        },
        {
            ...
            title: '测试新闻分页',
            component: markRaw(TestNewsPaginate)
        },
        {
            name: 'TestNewsPaginateX',
            title: '大数据分页',
            component: markRaw(TestNewsPaginateX)
        },
        {
            name: 'TestNews',
            title: '测试新闻',
            component: markRaw(TestNews)
        },
        {
            name: 'SlTestNews',
            title: '测试新闻[多场景]',
            component: markRaw(SlTestNews)
        },
        {
            name: 'TestList',
            title: '测试列表',
            component: markRaw(TestList)
        }
    ]
})
</script>
